...
Setting up the parse tree is the boring part of compilation, but most intro courses only focus on lexing and parsing. Most of the interesting analysis and transformation on source code happens after the creation of an [Abstract Syntax Tree (AST)](https://en.wikipedia.org/wiki/Abstract_syntax_tree).
...
This blog will mainly focus on the middle end of the compiler - the part after the AST has been created.
